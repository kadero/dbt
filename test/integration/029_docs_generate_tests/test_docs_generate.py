        ...
        return {
            ...
            'nodes': {
                ...
                'test.test.not_null_model_id.d01cc630e6': {
                    ...
                    'compiled_path': Normalized('target/compiled/test/models/schema.yml/test/not_null_model_id.sql'),
                    'build_path': None,
                    'created_at': ANY,
                    'column_name': 'id',
                    'columns': {},
                    ...
                    'deferred': False,
                    'description': '',
                    'fqn': ['test', 'test', 'not_null_model_id'],
                    'name': 'not_null_model_id',
                    'original_file_path': model_schema_yml_path,
                    'package_name': 'test',
                    'patch_path': None,
                    'path': Normalized('test/not_null_model_id.sql'),
                ...
                'test.test.test_nothing_model_.5d38568946': {
                    ...
                    'compiled_path': Normalized('target/compiled/test/models/schema.yml/test/test_nothing_model_.sql'),
                    'build_path': None,
                    'created_at': ANY,
                    'column_name': None,
                    'columns': {},
                    ...
                    'deferred': False,
                    'description': '',
                    'fqn': ['test', 'test', 'test_nothing_model_'],
                    'name': 'test_nothing_model_',
                    'original_file_path': model_schema_yml_path,
                    'package_name': 'test',
                    'patch_path': None,
                    'path': normalize('test/test_nothing_model_.sql'),
                ...
                'test.test.unique_model_id.67b76558ff': {
                    ...
                    'compiled_path': Normalized('target/compiled/test/models/schema.yml/test/unique_model_id.sql'),
                    'build_path': None,
                    'created_at': ANY,
                    'column_name': 'id',
                    'columns': {},
                    ...
                    'deferred': False,
                    'description': '',
                    'fqn': ['test', 'test', 'unique_model_id'],
                    'name': 'unique_model_id',
                    'original_file_path': model_schema_yml_path,
                    'package_name': 'test',
                    'patch_path': None,
                    'path': normalize('test/unique_model_id.sql'),
